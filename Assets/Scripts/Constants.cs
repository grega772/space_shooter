...
public class Constants : MonoBehaviour {
    ...
    public readonly static float SCOUT_ENEMY_SPEED = 8f;
    ...
    public readonly static float HEAVY_ENEMY_SPEED = 0.5f;
    ...
    public readonly static int HEALTH_PICKUP_VALUE = 50;
    public readonly static int MEGA_HEALTH_PICKUP_VALUE = 75;

    public readonly static float HEAVY_TURRET_MOVE_SPEED = 1f;
